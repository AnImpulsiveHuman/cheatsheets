...
app.use(helmet.hidePoweredBy({ setTo: 'PHP 4.2.0' })) -> Change the x-powered-by header
...
app.use(helmet.hsts({maxAge: 7776000, force: true}))  -> uses https for the next 90 days, force: overides the default https settings
